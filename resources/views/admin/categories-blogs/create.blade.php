...
<div class="container-fluid">
    ...
    <div class="row">
        <h1 class="h3 mb-2 text-gray-800"><a href="{{ route('categories-blogs.index') }}"
                style="text-decoration: none; color: purple"><i class="fa fa-chevron-left"></i> Back categories blog</a>
        </h1>
    </div>
    <!-- Content Row -->
    <div class="row">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-area" style="height: auto">
                        <form method="post" action="{{ route('categories-blogs.store') }}" enctype="multipart/form-data"
                            id="my-form">
                            @csrf
