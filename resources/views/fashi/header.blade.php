                ...
                <div class="col-lg-3 text-right col-md-3">
                    <ul class="nav-right">
                        ...
                        <span id="change-item-cart">
                            ...
                            <li class="cart-icon">
                                ...
                                <div class="cart-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="si-text">
                                                        <div class="product-selected">
                                                            ...
                                                            <h6><a
                                                                    href="{{ url('/shop/detail/' . Str::slug($row->name)) }}">{{ $row->name }}
                                                                    -
                                    ...
                                    <div class="select-total">
                                        <span>total:</span>
                                        <h5><b>${{ number_format(Cart::instance(Auth::user()->id)->total(), 2, ".", ",") }}</b>
                                        </h5>
                                    </div>
                            ...
                            <li class="cart-price">
                                ${{ number_format(Cart::instance(Auth::user()->id)->total(), 2, ".", ",") }}</li>
                            @endif
