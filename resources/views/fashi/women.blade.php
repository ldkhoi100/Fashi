    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                ...
                <form action="{{ route('womenSortPrice') }}" method="GET">
                    @csrf
                    <div class="filter-widget">
                ...
                <div class="product-show-option">
                    ...
                    <div class="row" style="margin: auto;">
                        ...
                        <span style="border: 1px solid #dadada; border-radius: 12px; padding: 0px 10px; color: #5d5d5d">
                            ${{ $min }} - ${{ $max }} <a href="{{ route('women') }}" style="color: #5d5d5d"><i
                        ...
                        <div class="col-lg-12 col-md-7">
                            <div class="select-option" style="float: right">
                                <select class="sorting" onchange="window.location.href=this.value;">
                                    <option value='/shop/women' data-title="English">
                                        Sort By</option>
                                    <option value="/women/sort/low&to&high" @if(Request::is('women/sort/low&to&high'))
                                        selected @endif>Price low to high</option>
                                    <option value="/women/sort/high&to&low" @if(Request::is('women/sort/high&to&low'))
